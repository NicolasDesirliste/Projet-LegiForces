...
Rectangle {
    ...
    Column {
        ...
        Repeater {
            model: [
                { title: "Nouvelle Affaire", actionId: "new-case" },
                { title: "Rechercher", actionId: "search" },
                { title: "Rapports", actionId: "reports" },
                { title: "Calculatrice PA", actionId: "calculator" },
                { title: "Place Holder 1", actionId: "placeholder1" },
                { title: "Place Holder 2", actionId: "placeholder2" }
            ]

            delegate: Rectangle {
                width: parent.width - 20
                height: 40
                color: mouseArea.containsMouse ? "#004678" : "transparent"
                border.width: 1
                border.color: "#0288f5"
                anchors.horizontalCenter: parent.horizontalCenter
                ...
                Text {
                    ...
                    color: mouseArea.containsMouse ? "#0288f5c9" : "#8cbceccb"
                ...
                MouseArea {
                    ...
                    onClicked: {
                        rightSidebar.actionRequested(modelData.actionId)
                    }
                }
            }
        }
